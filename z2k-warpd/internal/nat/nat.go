// Package nat — MASQUERADE и MSS-clamp для z2ktunN.
//
// Интерфейс не зарегистрирован в NDM, поэтому NDM его не NAT-ит и MSS не
// режет — делаем сами. Правила NDM сносит на каждом регене netfilter; их
