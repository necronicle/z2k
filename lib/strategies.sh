...
create_default_strategy_files() {
    ...
    # Дефолтная UDP стратегия (QUIC) — полный набор 12 стратегий с z2k morph.
