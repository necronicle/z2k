...
TMPJUNK
    ...
    for tool_script in z2k-config-validator.sh z2k-update-lists.sh z2k-diag.sh z2k-geosite.sh z2k-auto-update.sh z2k-stats-upload.sh z2k-warp.sh z2k-dns-check.sh z2k-tcp16-probe.sh z2k-sni-select.sh; do
