...
# ==============================================================================
# РЁРђР“ 0: РџР РћР’Р•Р РљРђ ROOT РџР РђР’ (РљР РРўРР§РќРћ)
# ==============================================================================
...
# ==============================================================================
# РЁРђР“ 1: РћР‘РќРћР’Р›Р•РќРР• РџРђРљР•РўРћР’
# ==============================================================================
...
step_update_packages() {
    ...
    if [ "$exit_code" -eq 0 ]; then
        ...
        if opkg --version 2>&1 | grep -qi "illegal"; then
            ...
            print_warning "РџР РР§РРќРђ: opkg СѓСЃС‚Р°РЅРѕРІР»РµРЅ РґР»СЏ РЅРµРїСЂР°РІРёР»СЊРЅРѕР№ Р°СЂС…РёС‚РµРєС‚СѓСЂС‹ CPU!"
        ...
        if opkg --version 2>&1 | grep -qi "illegal"; then
            cat <<'EOF'
вљ пёЏ  РљР РРўРР§Р•РЎРљРђРЇ РџР РћР‘Р›Р•РњРђ: РќР•РџР РђР’РР›Р¬РќРђРЇ РђР РҐРРўР•РљРўРЈР Рђ ENTWARE

Р”РёР°РіРЅРѕСЃС‚РёРєР° РїРѕРєР°Р·Р°Р»Р°: opkg РЅРµ РјРѕР¶РµС‚ РІС‹РїРѕР»РЅРёС‚СЊСЃСЏ РЅР° СЌС‚РѕРј СЂРѕСѓС‚РµСЂРµ.
Р­С‚Рѕ РѕР·РЅР°С‡Р°РµС‚ С‡С‚Рѕ Entware СѓСЃС‚Р°РЅРѕРІР»РµРЅ РґР»СЏ РќР•РџР РђР’РР›Р¬РќРћР™ Р°СЂС…РёС‚РµРєС‚СѓСЂС‹ CPU.
...
2. РЈСЃС‚Р°РЅРѕРІРёС‚Рµ РџР РђР’РР›Р¬РќРЈР® РІРµСЂСЃРёСЋ Entware:
...
Р Р•РљРћРњР•РќР”РђР¦РР РџРћ РЈРЎРўР РђРќР•РќРР®:
...
РџР РћР”РћР›Р–РРўР¬ Р‘Р•Р— РћР‘РќРћР’Р›Р•РќРРЇ?
...
EOF
            ...
            cat <<'EOF'
вљ пёЏ  РћРЁРР‘РљРђ РџР Р РћР‘РќРћР’Р›Р•РќРР РџРђРљР•РўРћР’
...
EOF
        ...
        case "$answer" in
            [Nn]|[Nn][Oo])
                ...
                print_info "РСЃРїСЂР°РІСЊС‚Рµ РїСЂРѕР±Р»РµРјСѓ Рё Р·Р°РїСѓСЃС‚РёС‚Рµ СЃРЅРѕРІР°"
                return 1
                ;;
            *)
...
step_check_dns() {
    ...
    if [ $dns_works -eq 0 ]; then
        ...
        case "$answer" in
            ...
            *)
                print_info "РЈСЃС‚Р°РЅРѕРІРєР° РїСЂРµСЂРІР°РЅР°"
                print_info "РСЃРїСЂР°РІСЊС‚Рµ DNS Рё Р·Р°РїСѓСЃС‚РёС‚Рµ СЃРЅРѕРІР°"
                return 1
                ;;
        esac
    fi
...
# ==============================================================================
# РЁРђР“ 3: РЈРЎРўРђРќРћР’РљРђ Р—РђР’РРЎРРњРћРЎРўР•Р™ (Р РђРЎРЁРР Р•РќРћ)
# ==============================================================================
...
"
    ...
    # =========================================================================
    # РљР РРўРР§РќР«Р• РџРђРљР•РўР« Р”Р›РЇ ZAPRET2 (РёР· check_prerequisites_openwrt)
    # =========================================================================
    ...
    # ipset - РљР РРўРР§РќРћ РґР»СЏ С„РёР»СЊС‚СЂР°С†РёРё РїРѕ СЃРїРёСЃРєР°Рј РґРѕРјРµРЅРѕРІ
    ...
    # xt_NFQUEUE - РљР РРўРР§РќРћ РґР»СЏ РїРµСЂРµРЅР°РїСЂР°РІР»РµРЅРёСЏ РІ NFQUEUE
    ...
    print_separator
    print_info "РџР РРњР•Р§РђРќРР•: РќР° Keenetic РјРѕРґСѓР»Рё iptables (xt_NFQUEUE, xt_connbytes,"
    print_info "xt_multiport) РІСЃС‚СЂРѕРµРЅС‹ РІ СЏРґСЂРѕ Рё РЅРµ С‚СЂРµР±СѓСЋС‚ РѕС‚РґРµР»СЊРЅРѕР№ СѓСЃС‚Р°РЅРѕРІРєРё."

    # =========================================================================
    # РћРџР¦РРћРќРђР›Р¬РќР«Р• РћРџРўРРњРР—РђР¦РР (GNU gzip/sort)
    # =========================================================================
...
# ==============================================================================
# РЁРђР“ 4: РЈРЎРўРђРќРћР’РљРђ ZAPRET2 (РРЎРџРћР›Р¬Р—РЈРЇ РћР¤РР¦РРђР›Р¬РќР«Р™ install_bin.sh)
# ==============================================================================
...
step_build_zapret2() {
    ...
    # ===========================================================================
    # РЁРђР“ 4.3: РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ install_bin.sh РґР»СЏ СѓСЃС‚Р°РЅРѕРІРєРё Р±РёРЅР°СЂРЅРёРєРѕРІ
    # ===========================================================================
...
# ==============================================================================
# РЁРђР“ 7: РћРџР Р•Р”Р•Р›Р•РќРР• РўРРџРђ FIREWALL (РљР РРўРР§РќРћ)
# ==============================================================================
...
step_check_and_select_fwtype() {
    ...
    if [ -z "$FWTYPE" ]; then
        ...
        print_warning "РСЃРїРѕР»СЊР·СѓРµРј fallback: iptables"
    fi
...
# ==============================================================================
# РЁРђР“ 8: Р—РђР“Р РЈР—РљРђ РЎРџРРЎРљРћР’ Р”РћРњР•РќРћР’
# ==============================================================================

step_download_domain_lists() {
    print_header "РЁР°Рі 8/12: Р—Р°РіСЂСѓР·РєР° СЃРїРёСЃРєРѕРІ РґРѕРјРµРЅРѕРІ"

    # РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ С„СѓРЅРєС†РёСЋ РёР· lib/config.sh
...
# ==============================================================================
# РЁРђР“ 7: РћРўРљР›Р®Р§Р•РќРР• HARDWARE NAT
# ==============================================================================
...
step_disable_hwnat_and_offload() {
    ...
    print_separator
    print_info "РРЅС„РѕСЂРјР°С†РёСЏ Рѕ flow offloading:"
...
# ==============================================================================
# РЁРђР“ 9.5: РќРђРЎРўР РћР™РљРђ TMPDIR Р”Р›РЇ LOW RAM РЎРРЎРўР•Рњ
# ==============================================================================
...
step_configure_tmpdir() {
    ...
    # РђР’РўРћРњРђРўРР§Р•РЎРљРР™ РІС‹Р±РѕСЂ TMPDIR РЅР° РѕСЃРЅРѕРІРµ RAM
...
# ==============================================================================
# РЁРђР“ 10: РЎРћР—Р”РђРќРР• РћР¤РР¦РРђР›Р¬РќРћР“Рћ CONFIG Р INIT РЎРљР РРџРўРђ
# ==============================================================================
...
# ==============================================================================
# РЁРђР“ 10: Р¤РРќРђР›РР—РђР¦РРЇ
# ==============================================================================
...
step_finalize() {
    ...
    # =========================================================================
    # РќРђРЎРўР РћР™РљРђ РђР’РўРћРћР‘РќРћР’Р›Р•РќРРЇ РЎРџРРЎРљРћР’ Р”РћРњР•РќРћР’ (РљР РРўРР§РќРћ)
    # =========================================================================
