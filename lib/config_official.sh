...
AUSTERUS_OPT
    ...
    add_hostlist_line "${extra_strats_dir}/TCP/RKN/List.txt" "--filter-tcp=80 --hostlist-exclude=${lists_dir}/whitelist.txt --hostlist=${extra_strats_dir}/TCP/RKN/List.txt${rkn_http_extras} --in-range=-s5556 --payload=http_req,empty,http_reply --lua-desync=circular:fails=2:time=60:reset:key=http_rkn:nld=2:failure_detector=${http_rkn_failure_detector}:success_detector=z2k_http_success_positive_only:no_http_redirect --lua-desync=z2k_http_flood_white:payload=http_req:dir=out:host=web.max.ru:count=10:badsum:pos=method+2:strategy=1 --lua-desync=http_methodeol:payload=http_req:dir=out:strategy=2 --lua-desync=syndata:payload=http_req:dir=out:strategy=3 --lua-desync=multisplit:payload=http_req:dir=out:strategy=3 --lua-desync=hostfakesplit:payload=http_req:dir=out:ip_ttl=2:repeats=1:strategy=4 --lua-desync=fake:payload=http_req:dir=out:blob=fake_default_http:badsum:repeats=1:strategy=5 --lua-desync=fakedsplit:payload=http_req:dir=out:pos=method+2:badsum:strategy=6 --lua-desync=fake:payload=http_req:dir=out:blob=0x0E0E0F0E:tcp_md5:strategy=7 --lua-desync=multisplit:payload=http_req:dir=out:pos=host+1:seqovl=2:strategy=7 --lua-desync=fake:payload=http_req:dir=out:blob=fake_default_http:badsum:repeats=1:strategy=8 --lua-desync=multisplit:payload=http_req:dir=out:pos=method+2:strategy=8 --lua-desync=z2k_http_methodeol_safe:payload=http_req:dir=out:strategy=9 --lua-desync=z2k_http_xpadding:payload=http_req:dir=out:strategy=10 --lua-desync=z2k_http_inject_safe_header:payload=http_req:dir=out:strategy=11 --lua-desync=z2k_http_simple_bypass:payload=http_req:dir=out:strategy=12 --lua-desync=z2k_http_lf_prefix:payload=http_req:dir=out:strategy=13 --lua-desync=z2k_http_space_prefix:payload=http_req:dir=out:strategy=14 --lua-desync=z2k_http_tab_prefix:payload=http_req:dir=out:strategy=15 --lua-desync=z2k_http_multi_crlf:payload=http_req:dir=out:strategy=16 --lua-desync=z2k_http_mixed_prefix:payload=http_req:dir=out:strategy=17 --lua-desync=z2k_http_garbage_prefix:payload=http_req:dir=out:strategy=18 --lua-desync=z2k_http_hostmod:payload=http_req:dir=out:strategy=19 --lua-desync=z2k_http_method_obfuscate:payload=http_req:dir=out:strategy=20 --lua-desync=z2k_http_version_downgrade:payload=http_req:dir=out:strategy=21 --lua-desync=z2k_http_oob_prefix:payload=http_req:dir=out:strategy=22 --lua-desync=z2k_http_absolute_url:payload=http_req:dir=out:strategy=23 --lua-desync=z2k_http_absolute_uri_v2:payload=http_req:dir=out:strategy=24 --lua-desync=z2k_http_methodeol_v2:payload=http_req:dir=out:strategy=25 --lua-desync=z2k_http_methodeol_hostcase:payload=http_req:dir=out:strategy=26 --lua-desync=z2k_http_pipeline_fake:payload=http_req:dir=out:strategy=27 --lua-desync=z2k_http_pipeline_fake_v2:payload=http_req:dir=out:strategy=28 --lua-desync=z2k_http_fake_continuation:payload=http_req:dir=out:strategy=29 --lua-desync=z2k_http_fake_xhost:payload=http_req:dir=out:strategy=30 --lua-desync=z2k_http_header_shuffle:payload=http_req:dir=out:strategy=31 --lua-desync=z2k_http_host_bytesplit:payload=http_req:dir=out:strategy=32 --lua-desync=z2k_http_seqovl_host:payload=http_req:dir=out:strategy=33 --lua-desync=z2k_http_triple_seqovl:payload=http_req:dir=out:strategy=34 --lua-desync=z2k_http_mgts_combo:payload=http_req:dir=out:strategy=35 --lua-desync=z2k_http_combo_bypass:payload=http_req:dir=out:strategy=36 --lua-desync=z2k_http_super_decoy:payload=http_req:dir=out:strategy=37 --lua-desync=z2k_http_multidisorder:payload=http_req:dir=out:strategy=38 --lua-desync=z2k_http_ipfrag:payload=http_req:dir=out:strategy=39 --lua-desync=z2k_http_syndata:payload=http_req:dir=out:strategy=40 --lua-desync=z2k_http_aggressive:payload=http_req:dir=out:strategy=41 --in-range=x --new"
