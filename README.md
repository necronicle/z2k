...
- **Веб-панель** — управление и мониторинг через браузер: статус и запуск сервиса, стратегии, списки, диагностика с проверкой отдельного домена, обновление и удаление z2k. Открывается без интернета: шрифты и всё остальное лежат на самом роутере, ни одного обращения наружу
