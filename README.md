...
- **Веб-панель** — управление и мониторинг через браузер: статус и запуск сервиса, стратегии, списки, диагностика, обновление и удаление z2k. Открывается без интернета: шрифты и всё остальное лежат на самом роутере, ни одного обращения наружу
...
Разделы панели: **Дашборд** (статус сервиса, запуск/остановка/перезапуск, баннер обновления z2k, удаление z2k — см. ниже), **Режимы** (переключатели функций), **Стратегии** (см. ниже), **WARP** (списки игровых IP — см. ниже), **Исключения** (см. ниже), **Доп. домены** (свой список доменов для обхода), **Диагностика** (см. ниже), **Благодарности**.
