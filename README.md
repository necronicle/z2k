...
**Модульный установщик zapret2 для роутеров Keenetic с Entware**

Первая реализация zapret2 специально для роутеров Keenetic с модульной архитектурой, 458 готовыми стратегиями из blockcheck2 и гибридным режимом тестирования.
...
4. **9-шаговая установка zapret2**:
   - Обновление пакетов
   - Установка зависимостей (gcc, make, библиотеки)
   - Загрузка модулей ядра
   - Сборка zapret2 с ARM64 патчем
   - Проверка установки
