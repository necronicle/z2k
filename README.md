...
Разделы панели: **Дашборд** (статус сервиса, запуск/остановка/перезапуск, баннер обновления z2k), **Режимы** (переключатели функций), **Стратегии** (см. ниже), **WARP** (списки игровых IP — см. ниже), **Исключения** (см. ниже), **Доп. домены** (свой список доменов для обхода), **Диагностика** (см. ниже), **Благодарности**.
