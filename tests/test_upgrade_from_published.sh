...
# ============================================================================
#
# Порядок разрешения тот же, что у гейта манифеста в scripts/ci_local.sh:
# сперва remote-tracking ссылка, затем локальная ветка. SHA — последний рубеж
# на случай окружения вовсе без этих ссылок; он не «версия проекта», а просто
# точка, от которой заведомо есть история.
PUB=""
for _r in origin/z2k-enhanced z2k-enhanced 54b6765; do
